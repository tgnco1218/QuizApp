...
// https://codewithchris.com/code/QuestionData.json
...
class ViewController: UIViewController, QuizProtocol, UITableViewDelegate, UITableViewDataSource, ResultViewControllerProtocol {
    ...
    func questionsRetrieved(_ questions: [Question]) {
        ...
        if savedIndex != nil && savedIndex! < self.questions.count {
            ...
            // Retrieve the number correct from the storage
    ...
    func dialogDismissed() {
        ...
        if currentQuestionIndex == questions.count {
            ...
            // Display and anime in the question
            displayQuestion()
        }
            ...
            // Save state
            StateManager.saveState(numCorrect: numCorrect, question: currentQuestionIndex)
        }
